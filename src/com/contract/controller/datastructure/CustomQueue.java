package com.contract.controller.datastructure;
...
public class CustomQueue {
    ...
    private LinkedList<ContractModel> vivaList; // Internal storage for the queue.
     ...
     *
     * @return the first ContractModel in the queue, or null if the queue is
 empty.
     * @throws IllegalStateException if the queue is empty.
     */
    public ContractModel deQueue() {
        try {
     ...
     *
     * @param studentModel the ContractModel to be added to the queue.
     * @return the current size of the queue after the operation , or -1 if the
     * queue is full.
     */
    public int enQueue(ContractModel studentModel) {
        if (isFull()) {
